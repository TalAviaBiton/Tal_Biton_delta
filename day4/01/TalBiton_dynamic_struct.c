/*------------------------------------------------------
* Filename: TalBiton_dynamic_struct.c
...
int main(){
    ...
    while(clock1->hour>23||clock1->hour<0||clock1->minuts>59||clock1->minuts<0||clock1->seconds>59||clock1->seconds<0){
    ...
    while(clock2->hour>23||clock2->hour<0||clock2->minuts>59||clock2->minuts<0||clock2->seconds>59||clock2->seconds<0){
        printf("please enter the second clock again:\n");
        scanf("%d %c %d %c %d",&(clock2->hour),&dots,&(clock2->minuts),&dots,&(clock2->seconds));
    }

    clock1= add_clocks(*clock1, *clock2);
